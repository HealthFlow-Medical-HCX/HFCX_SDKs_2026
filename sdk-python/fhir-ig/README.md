...
that the Python SDK ships with. Mirror of the Java SDK's `fhir-ig/`.

| File                  | Purpose                                                  |
|-----------------------|----------------------------------------------------------|
| `egyptian-ig.tgz`     | The IG package (NPM-style FHIR package). **Synced from `hfcx-platform` releases.** Not committed until Sprint P6. |
...
5. (Sprint P6+) updates the bundled-version constant in `hfcx_sdk`.
